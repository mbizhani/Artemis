...
def before(InitContext init) {
	...
	/*
	  You can define classes in 'files/groovy/lang' with package 'groovy.lang', and use it without import,
	  such as Helper:
	*/
	Helper helper = new Helper("Hello")
	helper.printMessage()
}
...
def FirstScenario(Context ctx) {
	println("----> Method Called Before Scenario 'FirstScenario'")
}

def firstGet(Context ctx) {
	println("----> Method Called Get Request 'firstGet'")
}
